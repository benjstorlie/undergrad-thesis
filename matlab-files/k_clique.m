...
function listOfCliques=k_clique(k,M)
%listOfCliques 
% How do I make it faster?


    numVertices=size(M,1);
    listOfCliques=zeros(0,k);
...
%              end
          ...
          [I,J] = find(M);
          listOfCliques = [I, J];
          listOfCliques = listOfCliques(listOfCliques(:,1) > listOfCliques(:,2),:);
...
%             end
        ...
        listOfCliques=unique(sort(listOfCliques,2),'rows');
        
        toc
        disp(sprintf('%d %d-cliques found', size(listOfCliques,1), k))
